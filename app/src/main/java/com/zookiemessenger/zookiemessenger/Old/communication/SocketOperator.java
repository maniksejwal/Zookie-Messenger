package com.zookiemessenger.zookiemessenger.Old.communication;
...
{
	private static final String AUTHENTICATION_SERVER_ADDRESS = "http://192.168.43.33/android-im/index.php"; //TODO change to your WebAPI Address
